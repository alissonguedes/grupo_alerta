...
@section('content')
    ...
    <div class="responsive-table">
        ...
        <div class="top flex mb-1">
            ...
            <div class="actions action-btns flex flex-col align-itens-center">
                ...
                <div class="show-buttons">
                    <button type="button" class="btn btn-large waves-effect" data-href="{{ route('admin.empresas.add') }}" data-tooltip="Adicionar">
                ...
                <div class="hide-buttons">
                    ...
                    <button class="btn btn-large update waves-effect" name="status" value="0" data-tooltip="" data-on="Bloquear" data-off="Desbloquear" data-link="{{ route('admin.empresas.patch', 'status') }}" data-method="patch">
                        <i class="material-icons" data-on="lock" data-off="lock_open"></i>
                    </button>

                    <button class="btn btn-large excluir waves-effect" disabled="disabled" data-link="{{ route('admin.empresas.delete') }}" style="border: none" data-tooltip="Excluir">
        ...
        <div class="content">
            ...
            <table class="table dataTable no-footer" data-link="{{ route('admin.empresas') }}">
                <thead>
                    <tr>
                        ...
                        <th class="white-text">Empresa</th>
